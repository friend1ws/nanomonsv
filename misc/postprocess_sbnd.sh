...
nanomonsv subscript_postprocess_sbnd/insert_classify ${NANOMONSV_PREFIX}.nanomonsv.annot.proc.result.txt.tmp ${NANOMONSV_PREFIX}.nanomonsv.annot.proc.result.txt ${REFERENCE_GENOME} --genome_id hg38
